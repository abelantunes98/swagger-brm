 ...
 */
@Schema(description = "An invoice payment method.")
@Validated
...
public class InvoiceType   {
  ...
  public InvoiceType extension(Object extension) {
  ...
  public InvoiceType id(String id) {
    this.id = id;
    return this;
  }
  ...
  public InvoiceType paymentType(Integer paymentType) {
  ...
  public InvoiceType accountRef(ResourceRef accountRef) {
  ...
  public InvoiceType correctiveInvoiceType(Integer correctiveInvoiceType) {
  ...
  public InvoiceType details(Details details) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.extension, invoiceType.extension) &&
        Objects.equals(this.id, invoiceType.id) &&
        Objects.equals(this.name, invoiceType.name) &&
        Objects.equals(this.paymentType, invoiceType.paymentType) &&
        Objects.equals(this.accountRef, invoiceType.accountRef) &&
        Objects.equals(this.correctiveInvoiceType, invoiceType.correctiveInvoiceType) &&
