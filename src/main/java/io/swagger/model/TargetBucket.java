 ...
 */
@Schema(description = "The bucket at the target.")
@Validated
...
public class TargetBucket   {
  ...
  public TargetBucket validFrom(OffsetDateTime validFrom) {
  ...
  public TargetBucket validTo(OffsetDateTime validTo) {
  ...
  public TargetBucket currentBalance(BigDecimal currentBalance) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TargetBucket targetBucket = (TargetBucket) o;
    return Objects.equals(this.validFrom, targetBucket.validFrom) &&
        Objects.equals(this.validTo, targetBucket.validTo) &&
        Objects.equals(this.currentBalance, targetBucket.currentBalance);
  }
