...
@RestController
public class DepositPaymentApiController implements DepositPaymentApi {

    private static final Logger log = LoggerFactory.getLogger(DepositPaymentApiController.class);
    ...
    public DepositPaymentApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<EntityRef> createDepositWithPayment(@Parameter(in = ParameterIn.DEFAULT, description = "The deposit payment. The minimum required parameters are:<ul><li><b>customerRef</b></li><li><b>customerDepositRef</b></li><li><b>paymentAmount</b></li><li><b>paymentRef</b></li></ul>", schema=@Schema()) @Valid @RequestBody DepositPayment body) {
