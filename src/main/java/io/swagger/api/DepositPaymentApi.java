...
public interface DepositPaymentApi {
    ...
    @Operation(summary = "Create a Customer Deposit Payment", description = "Creates a customer deposit payment.", tags={ "Deposits" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "201", description = "The customers deposit payment was created successfully.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = EntityRef.class))),
    ...
    @RequestMapping(value = "/depositPayment",
