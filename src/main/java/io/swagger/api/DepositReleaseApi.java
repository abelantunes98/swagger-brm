...
@Validated
public interface DepositReleaseApi {

    @Operation(summary = "Release a Customer Deposit", description = "Releases a customer deposit.", tags={ "Deposits" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "201", description = "The deposit was released successfully.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = EntityRef.class))),
    ...
    @RequestMapping(value = "/depositRelease",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<EntityRef> createDepositRelease(@Parameter(in = ParameterIn.DEFAULT, description = "The deposit to release. The minimum required parameters are:<ul><li><b>customerRef</b></li><li><b>customerDepositRef</b></li></ul>", schema=@Schema()) @Valid @RequestBody DepositRelease body);
