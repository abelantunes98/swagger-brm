...
@Validated
public interface DepositTransferApi {

    @Operation(summary = "Transfer a Customer Deposit", description = "Transfers the specified customer deposit.", tags={ "Deposits" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "201", description = "The customer deposit was transfered successfully.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = EntityRef.class))),
    ...
    @RequestMapping(value = "/depositTransfer",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<EntityRef> transferCustomerDeposit(@Parameter(in = ParameterIn.DEFAULT, description = "The deposit to transfer. The minimum required parameters are:<ul><li><b>customerRef</b></li><li><b>customerDepositRef</b></li><li><b>destCustomerRef</b></li></ul>", schema=@Schema()) @Valid @RequestBody DepositTransfer body);
