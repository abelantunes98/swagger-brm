...
@RestController
public class StatusupdateApiController implements StatusupdateApi {

    private static final Logger log = LoggerFactory.getLogger(StatusupdateApiController.class);
    ...
    public ResponseEntity<Void> changeOffersStatus(@Parameter(in = ParameterIn.DEFAULT, description = "The offer's status details. The minimum required parameters are&colon;<ul><li><b>statusCode</b></li><li><b>effectiveDate</b>, if the status changes are deferred or backdated</li></ul>", schema=@Schema()) @Valid @RequestBody OfferStatus body) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }

    public ResponseEntity<Resource> changeServiceStatus(@Parameter(in = ParameterIn.PATH, description = "The ID of the service to update, such as 0.0.0.1+-service-ip+123123.", required=true, schema=@Schema()) @PathVariable("id") String id,@Parameter(in = ParameterIn.DEFAULT, description = "The status details. The minimum required parameters are&colon;<ul><li><b>statusCode</b></li><li><b>effectiveWhen</b>, if the status changes are deferred or backdated</li></ul>", schema=@Schema()) @Valid @RequestBody Status body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Resource>(objectMapper.readValue("{\n  \"reference\" : {\n    \"id\" : \"id\",\n    \"uri\" : \"uri\"\n  },\n  \"extension\" : { }\n}", Resource.class), HttpStatus.NOT_IMPLEMENTED);
