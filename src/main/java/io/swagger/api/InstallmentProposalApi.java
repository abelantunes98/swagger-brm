...
@Validated
public interface InstallmentProposalApi {

    @Operation(summary = "Create an Installment Proposal", description = "Creates an installment proposal.", tags={ "Installments" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "201", description = "The installment proposal was created successfully.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InstallmentSchedule.class))),
    ...
    @RequestMapping(value = "/installmentProposal",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<InstallmentSchedule> addInstallmentProposal(@Parameter(in = ParameterIn.DEFAULT, description = "The installment proposal to create. The minimum required parameters are&colon;<ul><li><b>customerRef</b></li><li><b>specRef</b></li><li><b>totalAmount</b></li></ul>", required=true, schema=@Schema()) @Valid @RequestBody InstallmentProposal body);
