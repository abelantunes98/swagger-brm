...
@Validated
public interface DepositTxnApi {

    @Operation(summary = "Get a Deposit Transaction by ID", description = "Gets the specified deposit transaction.", tags={ "Deposits" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "The deposit transaction was returned successfully.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DepositTxn.class))),
    ...
    @RequestMapping(value = "/depositTxn/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<DepositTxn> getDepositTxnById(@Parameter(in = ParameterIn.PATH, description = "The Deposit Transaction Event ID.", required=true, schema=@Schema()) @PathVariable("id") String id);
