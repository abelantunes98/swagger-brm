...
@Validated
public interface CancelInstallmentApi {

    @Operation(summary = "Cancel an Installment Schedule", description = "Cancels an installment schedule. The minimum required parameters are&colon;<ul><li><b>customerRef</b></li><li><b>installmentRef</b></li><li><b>notes</b></li></ul>", tags={ "Installments" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "201", description = "The installment schedule was canceled successfully.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = EntityRef.class))),
    ...
    @RequestMapping(value = "/cancelInstallment",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<EntityRef> cancelInstallment(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody CancelInstallment body);
